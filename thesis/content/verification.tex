...
Aj tieto experimenty potvrdili, že metóda s prekryvom hodntou jedna dosahuje najlepšie výsledky. Ďalej sme zistili, že nastavením menšieho prekryvu (parameter \textit{p} má vyššiu hodnotu) sme v kombinácii s vyšším počtom masiek dosiahli lepšie výsledky, pričom od 256 masiek boli tieto hodnoty takmer rovnaké (Obr. \ref{fig:risei_parameters}). Od 2048 masiek boli dosiahnuté výsledky takmer rovnaké, toto môže súvisieť aj so stabilitou tepelných máp pri vyšších hodnotách (Sekcia \ref{sec:risei_stability}).
...
Na vyhodnotenie tepelných máp pre každú snímku sme použili nasledovné metriky, pričom sme vychádzali z existujúcich prác popísaných v návrhu (\ref{sec:heat_maps_and_model_segmentation_masks}). Aj keď vygenerované tepelné mapy metódou RISEI majú rozsah hodnôt $<0, 1>$, tepelná škála je ale určená minimálnou a maximálnou hodnotou v tepelnej mape, preto sme tepelné mapy min-max škálovaním preškálovali aby sme mohli porovnať metriky hustoty medzi metódami.
...
Najlepšie výsledky dosiahla metóda Guided Backprop.
...
\begin{table}[]
    \begin{tabular}{|
        ...
        \small{A (AD + CN)}                                                   & 0.6779                                                                                                 & 0.6733                                                                                                & 0.4434                                             & 0.5717                                               & 0.6101                                                                                                      & 0.4011                                                                                                      \\ \hline
        \small{A (AD)}                                                              & 0.6779                                                                                                 & 0.6733                                                                                                & 0.4434                                             & 0.5717                                               & 0.6101                                                                                                      & 0.4011                                                                                                      \\ \hline
        \small{A (CN)}                                                              & 0.6779                                                                                                 & 0.6733                                                                                                & 0.4434                                             & 0.5717                                               & 0.6101                                                                                                      & 0.4011                                                                                                      \\ \hline
        ...
        \small{C (AD + CN)}                                                         & 0.5906                                                                                                 & 1.1902                                                                                                & 1.0015                                             & 1.5991                                               & 0.9809                                                                                                      & 1.0049                                                                                                      \\ \hline
        \small{C (AD)}                                                              & 0.5906                                                                                                 & 0.5811                                                                                                & 1.0026                                             & 0.8210                                               & 1.0001                                                                                                      & 0.9900                                                                                                      \\ \hline
        \small{C (CN)}                                                              & 0.5859                                                                                                 & 4.9193                                                                                                & 0.9992                                             & 6.5940                                               & 0.9798                                                                                                      & 1.0049                                                                                                      \\ \hline
        \small{D (AD + CN)}                                                         & 0.7527                                                                                                 & 1.1952                                                                                                & 0.9985                                             & 1.3722                                               & 0.9928                                                                                                      & 0.9996                                                                                                      \\ \hline
        \small{D (AD)}                                                              & 0.7626                                                                                                 & 0.8400                                                                                                & 0.9940                                             & 0.9403                                               & 1.0034                                                                                                      & 0.9952                                                                                                      \\ \hline
        \small{D (CN)}                                                              & 0.7269                                                                                                 & 3.0318                                                                                                & 1.0021                                             & 4.2573                                               & 0.9887                                                                                                      & 1.0011                                                                                                      \\ \hline
        \small{E (AD + CN)}                                                         & 0.6422                                                                                                 & 1.2169                                                                                                & 0.9958                                             & 1.4912                                               & 0.9874                                                                                                      & 1.0028                                                                                                      \\ \hline
        \small{E (AD)}                                                             & 0.6542                                                                                                 & 0.7034                                                                                                & 0.9946                                             & 0.8929                                               & 1.0015                                                                                                      & 0.9900                                                                                                      \\ \hline
        \small{E (CN)}                                                              & 0.6364                                                                                                 & 3.5285                                                                                                & 0.9990                                             & 5.0326                                               & 0.9833                                                                                                      & 1.0031                                                                                                      \\ \hline
    \end{tabular}
